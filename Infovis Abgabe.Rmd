...
# Bei allen Diagrammen Schriftgröße anpassen!
# Quellen anpassen
# Glossar einfügen als Anhang
```
...
# Zweites Diagramm mit dem Unterschied der Zahlung

```

####Zwischenfazit
Was zu allererst ins Auge fällt: Auch wenn der blaue und der rote Balken sehr nahe beieinanderliegen, so ist der Blaue überall (!) länger als der Rote. Frauen verdienen also auch im gleichen Arbeitsbereich weniger als Männer. Besonders ausgeprägt ist dies in den Feldern „Management“, „Legal“ und „Life, Physical and Social Science“. Etwas angeglichener ist es in „Personal Care and Service“ und „Food Preparation and Service Related“. Trotzdem ist deutlich zu erkennen, dass Frauen weniger verdienen als Männer. 
...
https://www.census.gov/programs-surveys/acs/data/pums.html (zuletzt aufgerufen am: )
...
https://fivethirtyeight.com/features/the-economic-guide-to-picking-a-college-major/ (zuletzt aufgerufen am: )
