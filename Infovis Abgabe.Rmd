...
Das erste Diagramm zeigt zum einen die Anzahl von Studienabschlüssen aufgeschlüsselt nach Kategorien in den USA und zum anderen die Aufteilung auf diese Abschlüsse nach Geschlecht sortiert. Als erstes stellt sich natürlich die Frage, ob Männer und Frauen die gleichen Fächer belegen oder ob es Unterschiede bei den einzelnen Studienschwerpunkten gibt. Werfen wir mal einen genaueren Blick auf die Daten: 
...
Kommen wir nun zu einer Kategorie, die für viele Arbeitnehmer einer der wichtigsten überhaupt ist: dem Gehalt. Auch hier gibt es geschlechtliche Unterschiede. Zunächst beschäftigen wir uns aber mit den Gehaltsklassen, die je nach Jobrichtung variieren. Denn ein College-Abschluss zu haben garantiert einem noch nicht einen ausreichenden Verdienst um damit monatlich über die Runden zu kommen. Schauen wir also auf die allgemeinen Gehälter, die unsere jungen Arbeitnehmer zu erwarten haben. Die folgende Tabelle ist interaktiv und du kannst dich selbstständig durch sie durchklicken und nach bestimmten Begriffen suchen.
