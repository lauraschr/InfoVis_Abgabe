...
jobs_gender %>% 
 ...
 ggplot() +
  ...
  coord_flip() +
  geom_bar(stat = "identity", fill = c(rwthcolors$petrol)) +
  scale_y_continuous(labels = scales::comma_format(big.mark = ".", decimal.mark = ",")) +
  theme(axis.text = element_text(size=11))  +
